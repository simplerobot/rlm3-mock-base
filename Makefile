...
CC = g++
CFLAGS = -Wall -Werror -DTEST -I$(MAIN_SOURCE_DIR) -I$(PKG_TEST_DIR) -I$(PKG_MOCK_DIR) -I$(PKG_LOGGER_DIR) -fsanitize=address -static-libasan -g -Og

LIBRARY_FILES = $(notdir $(wildcard $(MAIN_SOURCE_DIR)/*))

TEST_SOURCE_DIRS = $(MAIN_SOURCE_DIR) $(TEST_SOURCE_DIR) $(PKG_TEST_DIR) $(PKG_MOCK_DIR) $(PKG_LOGGER_DIR) 
